...
I dati in ingresso da utente, seguono un flusso ben preciso. Il gestore dell'input li rendere interpretabili dal resto del circuito oltre a prepare tutti gli altri segnali. La memoria poi gioca un ruolo fondamentale perchè è qui che i dati seguono 3 diverse linee di output/input:
